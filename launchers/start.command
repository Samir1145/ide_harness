...
# Dynamically resolve root directory of the repository (parent of launchers/)
...
"$ROOT_DIR/launchers/stop.command"

# Register trap to clean up on any exit or termination signal
trap '"$ROOT_DIR/launchers/stop.command"; exit' INT TERM HUP EXIT
