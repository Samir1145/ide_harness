...
const AdvisorAgent = require('../vault/agent_packs/legal_agents.vlt/agents/advisor/agent');
const FormsAgent = require('../vault/agent_packs/legal_agents.vlt/agents/forms/agent');
const DocumentAgent = require('../vault/agent_packs/legal_agents.vlt/agents/document/agent');
