...
function main() {
    console.log('Applying Hayagriva branding to the IDE build files...');

    // 1. Update resources/resources/preload.html
    ...
    // Modify the animation to only pulse (scale) and use opacity, removing color filter inversion
    preloadContent = preloadContent.replace(
    ...
    // 2. Generate new resources/resources/TheiaIDESplash.svg
...
<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 1160 484" width="445.5" height="186">
  ...
  <image href="data:image/png;base64,${base64White}" x="0" y="0" width="1160" height="484" />
    ...
    console.log(`- Generated new ${splashSvgPath}`);
    ...
    if (fs.existsSync(productIconsDir)) {
        ...
        console.warn(`Warning: Product icons directory not found at ${productIconsDir}`);
    }
